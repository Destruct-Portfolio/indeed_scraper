...
export default class DatabaseManager {
  ...
  public async initializeDatabase(database: string, query_company: string, query_reviews: string): Promise<void> {
  ...
  private createTableIfNotExists(query: string): Promise<void> {
  ...
  public insertData_company(data: Company[], table: string) {
